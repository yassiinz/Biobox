...
class MYPDF extends TCPDF {
    ...
    public function ColoredTable($header,$data) {
        ...
        $fill = 0;
        foreach($data as $row) {
            $this->Cell($w[0], 6, $row["idUtilisateur"], 'LR', 0, 'L', $fill);
            ...
            $this->Cell($w[5], 6, $row["confirmPassword"], 'LR', 0, 'L', $fill);
...
// column titles
$header = array('Id', 'First Name', 'Last Name', 'Email', 'Password', 'Confirm Pass', 'Type');
