          ...
          <form method="post" >
            <div class="row">
              ...
              <div class="form-group col-lg-12">
                <textarea name="sujj" class="form-control" placeholder="Type your message"  id="body" rows="10"></textarea>
              </div>
            </div>
...
$mail ->SMTPAuth=true;
$mail ->Username="contact.bioboxtn@gmail.com";
$mail ->Password='xgwgtifqyggpgecm';
$mail ->Port=465;
$mail ->SMTPSecure='ssl';
$mail->isHTML(true);
