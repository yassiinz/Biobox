...
<head>
    ...
    <body>
        <button><a href="listProduit.php">Return to Produit list </a></button>
        <hr>
        ...
        <form action="" method="POST">
            ...
            <tr>
                    <td>
                        <label for="nom_produit">Nom produit:
                        </label>
                    </td>
            ...
            <tr>
                    <td>
                        <label for="description_prod">Description:
                        </label>
                    </td>
                    <td><input type="text" name="description_prod" id="description_prod" ></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="prix_produit" id="prix_produit" ></td>
                </tr>
