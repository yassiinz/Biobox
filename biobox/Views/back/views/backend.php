...
<table border="1" align="center" width="70%" id="datatablesSimple">
    <tr>
        <th>Id</th>
        <th>First Name</th>
        <th>Last Name</th>
        ...
        <tr>
            ...
            <td align="center">
                <form method="POST" action="Update.php">
                    ...
                    <input type="hidden" value=<?PHP echo $user['idUtilisateur']; ?> name="idUtilisateur">
                </form>
            </td>
            <td>
                <a href="Mail.php?id=<?php echo $user['idUtilisateur']; ?>">Send Mail</a>
            </td>
        </tr>
    <?php
    }
...
<!-- <from methode="POST" action="pdf.php">
<input type="submit" value="convert to PDF" name="pdf_creater" class="btn btn-danger">
</from>  -->
<a href="pdf.php" class="btn btn-danger">Convert To PDF</a>   
                            </div>
                        </div>
                    </div>
                </main>
