<?php
    ...
    if (isset($_POST["nom"]) && isset($_POST["totale"]) && isset($_POST["adresse"]) &&	isset($_POST["date_commande"]) && isset($_POST["liste"])) {
        if ( !empty($_POST["nom"]) && !empty($_POST["totale"]) && !empty($_POST["adresse"]) && !empty($_POST["date_commande"]) && !empty($_POST["liste"])) {
					...
					<div class="col-lg-12">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									<input type="number" class="form-control" id="totale" name="totale" placeholder="totale" >
									<div class="help-block with-errors"></div>
								</div>                                 
								<div class="form-group">
								...
								<div class="form-group">
									<input type="date" class="form-control" id="date_commande" name="date_commande" value="2022-11-26">
									<div class="help-block with-errors"></div>
								</div>                                 
								<div class="form-group">
									<input type="text" class="form-control" id="liste" name="liste" placeholder="liste">
									<div class="help-block with-errors"></div>
								</div>                                                       
							</div> 							
							<div class="col-md-12">
