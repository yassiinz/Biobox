	...
	<div class="contact-box">
		...
		<table border="2" align="center" width="70%">
        	...
        	<tr>
            	...
            	<td align="center">
					<a href="updatePanier.php?id=<?php echo $panier['id_panier']; ?>">modifier</a>
            	</td>
            	<td>
                	<a href="deletePanier.php?id=<?php echo $panier['id_panier']; ?>">supprimer</a>
            	</td>
        	</tr>
    		<?php
    			}
		...
		<div class="col-md-12">
			<div class="submit-button text-center">
				<button class="btn btn-common" id="submit" onclick="document.location='listeCommande.php'">confirmer</button>
			</div>
		</div>
	</div>
	<br>
