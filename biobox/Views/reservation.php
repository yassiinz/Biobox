			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						?>
						<li class="nav-item active"><a class="nav-link" href="reservation.php">Panier</a></li>
						<?php
						}else{}
						?>
				   ...
				   <div class="table-responsive">  
						<table class="table table-bordered">  
							 ...
							 <tr>  
								  ...
								  <td><a href="reservation.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">supprimer</span></a></td>  
							 </tr>  
							 <?php  
						...
						<a class="btn btn-action btn-lg" role="button" href="ajoutcommand.php" >Passer Commande</a> 
				   </div>  
			  </div>  
			  <br /> 