...
<body>
	...
	<div class="all-page-title page-breadcrumb">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<br><h1> Catégories de nos restaurants  </h1>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- Start restaurants -->
				...
				<div class="col-lg-4 col-md-6 special-grid Symbiose Healthy Tasty Food">
					<div class="gallery-single fix">
						<img src="images/salé.jpg" class="img-fluid" alt="Image">
						<div class="why-text">
							<h4>Salés</h4>
							
							
							
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="stuff.php">restaurants</a></p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 special-grid Symbiose Healthy Tasty Food">
					<div class="gallery-single fix">
						<img src="images/sucre.jpg" class="img-fluid" alt="Image">
						<div class="why-text">
							<h4>Patisserie</h4>
							
							
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="sucre.php">restaurants</a></p>
						</div>
					</div>
				</div>
				</centre>
				<div class="col-lg-4 col-md-6 special-grid Symbiose Healthy Tasty Food">
					<div class="gallery-single fix">
						<img src="images/boisson.webp" class="img-fluid" alt="Image">
						<div class="why-text">
							<h4>Boissons</h4>
							
							
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="drinks.php">Restautrant</a></p>
						</div>
					</div>
				</div>
				</center>
