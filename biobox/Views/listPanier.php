...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="indexb.html">Bio-Box</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="listeCommande.php">commande</a>
                                    <a class="nav-link" href="listePanier.php">panier</a>
                                </nav>
                            </div>
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="registerb.html">Register</a>
                                            <a class="nav-link" href="passwordb.html">Forgot Password</a>
                                        </nav>
                                    </div>
                            ...
                            <a class="nav-link" href="chartsb.html">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                Charts
                            </a>
                            <a class="nav-link" href="tablesb.html">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Paniers</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="indexb.html">Acceuil</a></li>
                        ...
                        <div class="card mb-4">
                            <div class="card-body"> 
                                ...
                                ?>
                                <div align='center'>
                                    <form method="get" action="listePanier.php">
