<?php
    ...
    if ( isset($_POST["nom_article"]) && isset($_POST["quantite"])) {
        ...
        $panierC->update_panier($panier,$_GET['id']);
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" class="form-control" id="nom_article" name="nom_article" value=<?php echo $p['nom_article'] ?> placeholder="nom_article">
									<div class="help-block with-errors"></div>
								</div>                                 
								<div class="form-group">
									<input type="text" class="form-control" id="quantite" value=<?php echo $p['quantite'] ?> name="quantite" placeholder="quantite">
									<div class="help-block with-errors"></div>
								</div>                                                             
							</div>
							<div class="col-md-12">
